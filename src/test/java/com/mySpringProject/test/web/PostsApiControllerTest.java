...
public class PostsApiControllerTest {
    ...
    @Before // 테스트가 시작되기 전에 매번 MockMvc 인스턴스를 생성합니다.
    public void setup(){
        mvc = MockMvcBuilders
    ...
    @Test
    @WithMockUser(roles="USER") //인증된 더미 사용자를 만듭니다. roles를 통해 권한도 추가할 수 있습니다.
...
//        assertThat(all.get(0).getContent()).isEqualTo(content);
        ...
        mvc.perform(post(url) // 생성된 MockMvc를 통해 API를 테스트합니다.
                ...
                //body에 있는 본문 영역은 문자열로 표현하기 위해 ObjectMapper를 통해 문자열 JSON으로 변환합니다.
